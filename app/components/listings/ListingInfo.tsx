  ...
  return ( 
    ...
    >
      ...
      >
        ...
        >
          <div>{guestCount} {guestCount === 1 ? 'huesped' : 'huéspedes'}</div>
          <div>{roomCount} {roomCount === 1 ? 'habitación' : 'habitaciones'}</div>
          <div>{bathroomCount} {bathroomCount === 1 ? 'baño' : 'baños'}</div>
        </div>
      </div>
      <hr />
      {category && (
